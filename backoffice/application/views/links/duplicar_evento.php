...
<tr>
     <td>
        <div class="td_Titulo">
            <h3 class="Play">Duplicar link para Evento</h3>
    	</div>    
     </td>
</tr>
<tr>
            ...
            <td valign="top" style="margin:0;padding:0">
                ...
                <div class="td_Corpo">
                    ...
                    <?php 
                        ...
                        echo form_open_multipart(base_url() . 'links/salvar_duplicar_evento', $attributes); 
                    ...
                    <tr>
                        <td><input id="str_Url" name="str_Url" type="text" size="50" value="<?php echo set_value('str_Url', $DataBody->url); ?>-copia" /></td>
                    </tr>
                    <tr>
                        <td height="20"></td>
                    </tr>
