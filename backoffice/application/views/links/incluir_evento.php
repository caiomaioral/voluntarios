...
<tr>
     <td>
        <div class="td_Titulo">
            <h3 class="Play">Incluir link para Evento</h3>
    	</div>    
     </td>
</tr>
<tr>
            ...
            <td valign="top" style="margin:0;padding:0">
                ...
                <div class="td_Corpo">
                    ...
                    <?php 
                        ...
                        echo form_open_multipart(base_url() . 'links/enviar_evento', $attributes); 
                    ...
                    <tr>
                        <td><input id="str_Url" name="str_Url" type="text" size="50" value="<?php echo set_value('str_Url'); ?>" /></td>
                    </tr>
                    <tr>
                        <td height="20"></td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <?php
                                ...
                                echo form_dropdown('int_Gateway', $AddGateway, set_value('int_Gateway'), $js);                            
                            ?>  
                    ...
                    <tr>
                    	<td><input id="Data_Evento" name="Data_Evento" type="text" size="11" value="<?php echo set_value('Data_Evento'); ?>" readonly="true" class="date" /></td>
                    </tr>                    
                    <tr>
                        <td height="20"></td>
                    </tr>
                    ...
                    <tr>
                    	<td><input id="Fim_Evento" name="Fim_Evento" type="text" size="11" value="<?php echo set_value('Fim_Evento'); ?>" readonly="true" class="date" /></td>
                    </tr>                                          
                    <tr>
                        <td height="20"></td>
                    </tr>                        
                    ...
                    <tr>
                    	<td><input id="Data_Limite" name="Data_Limite" type="text" size="11" value="<?php echo set_value('Data_Limite'); ?>" readonly="true" class="date" /></td>
                    </tr>
                    <tr>
                        <td height="20"></td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <textarea id="editor" name="editor" rows="4" cols="50"><?php echo set_value('editor'); ?></textarea>                            
                    ...
                    <tr>
                        <td><input id="str_Valor" name="str_Valor" type="text" size="10" value="<?php echo set_value('str_Valor'); ?>" class="money" /></td>
                    </tr>
                    <tr>
                        <td height="20"></td>
                    </tr>
                    ...
                    <tr>
                        <td><input id="str_Transporte" name="str_Transporte" type="text" size="10" value="0,00" class="money" /></td>
                    </tr>
                    <tr>
                        <td height="20"></td>
                    </tr>
                    ...
                    <tr>
                        <td><input id="int_Limite" name="int_Limite" type="text" size="10" value="<?php echo set_value('int_Limite', 0); ?>" /></td>                           
                    </tr>
                    <tr>
                        <td height="20"></td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <?php
                                ...
                                echo form_dropdown('int_Adicionais', $AddAdicionais, set_value('int_Adicionais'), $js);                            
                            ?>  
