...
<tr>
     <td>
        <div class="td_Titulo">
            <h3 class="Play">Alterar Evento</h3>
    	</div>    
     </td>
</tr>
<tr>
            ...
            <td valign="top" style="margin:0;padding:0">
                ...
                <div class="td_Corpo">
                    ...
                    <?php 
                        ...
                        echo form_open_multipart(base_url() . 'eventos/salvar_evento', $attributes); 
                    ...
                    <tr>
                    	<td>
                            <?php
                                ...
                                echo form_dropdown('Igreja', $AddIgreja, set_value('Igreja', $DataBody->id_igreja), $js);                            
                    ...
                    <input id="ID" name="ID" type="hidden" value="<?php echo $DataBody->id_evento; ?>" />
